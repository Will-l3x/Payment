...
import "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";
 ...
 contract TokenPaymentSplitter {
    ...
    address internal paymentToken; //address for the token that we are going to use
    uint256 internal _totalShares; //provieds addition from total partcicipants 
    uint256 internal _totalTokenReleased; //total amount paid in winnings
    address[] internal _payees; //addresses for RUBi, treasury 
